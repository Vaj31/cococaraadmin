...
import 'package:ccpladmin/helpers/services/json_decoder.dart';
import 'package:ccpladmin/helpers/services/localizations/language.dart';
import 'package:ccpladmin/helpers/services/localizations/translator.dart';
  ...
  static void _notify() {
    ...
    if (NavigationService.globalContext != null) {
      try {
        ...
        debugPrint("Failed to update theme via Riverpod: $e");
      }
    }
