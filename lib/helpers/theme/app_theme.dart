...
import 'package:ccpladmin/helpers/widgets/my.dart';
...
import 'package:ccpladmin/helpers/widgets/my_screen_media.dart';
...
class AppStyle {
  ...
  static void initMyStyle() {
    ...
    MyTextStyle.changeFontFamily(GoogleFonts.plusJakartaSans);
    My.changeTheme(AppTheme.theme);
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem:
          MyBreadcrumbItem(name: 'Cococara'), //, route: '/'
    ));
    bool isMobile = true;
    try {
  ...
  static MaterialRadius buttonRadius =
      MaterialRadius(small: 4, medium: 8, large: 12);
  static MaterialRadius cardRadius =
      MaterialRadius(xs: 4, small: 6, medium: 10, large: 16);
