import 'package:ccpladmin/helpers/utils/generator.dart';
...
class MyTextUtils {
  ...
  static String getDummyText(int words,
    ...
    return Generator.getDummyText(words, withTab: withTab, withEmoji: withEmoji, withStop: withStop);
  }
  ...
  static String getParagraphsText(
    ...
    return Generator.getParagraphsText(paragraph: paragraph, words: words, noOfNewLine: noOfNewLine, withHyphen: withHyphen, withEmoji: withEmoji);
  }
  ...
  static String getTextFromSeconds(
      ...
      bool withSpace = true}) {
    return Generator.getTextFromSeconds(time: time, withZeros: withZeros, withHours: withHours, withMinutes: withMinutes, withSpace: withSpace);
  }
}
